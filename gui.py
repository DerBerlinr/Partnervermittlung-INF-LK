...
class GUI(Tk,Bewerber):
    def __init__(self):
        ...
        btn = Button(root, text = "Start", command = open)
        btn.place(x=75,y=50)
    ...
    def open(self):
        ...
        self.la7=Label(root,textvariable=self.la7_text, width=groesse, bg=farbe, justify=CENTER)
        self.la7.grid(row=7,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu3_1=Button(root,text="Raucher", width=groesse, command=self.raucher)
        self.bu3_1.grid(row=7,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu3_2=Button(root,text="Nichtraucher", width=groesse, command=self.nichtraucher)
        ...
        self.la13=Label(root,textvariable=self.la13_text, width=groesse, bg=farbe, justify=CENTER)
        self.la13.grid(row=13,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu5_1=Button(root,text="Telefon", width=groesse, command=self.telefon)
        self.bu5_1.grid(row=13,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu5_2=Button(root,text="Email", width=groesse, command=self.email)
        self.bu5_2.grid(row=13,column=2,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu5_3=Button(root,text="Post", width=groesse, command=self.post)
        ...
        self.la14=Label(root,textvariable=self.la14_text, width=groesse, bg=farbe, justify=CENTER)
        self.la14.grid(row=14,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu6_1=Button(root,text="Lastschrift", width=groesse, command=self.lastschrift)
        self.bu6_1.grid(row=14,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu6_2=Button(root,text="Ueberweisung", width=groesse, command=self.ueberweisung)
        self.bu6_2.grid(row=14,column=2,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la15_text=StringVar()
        self.la15_text.set("IBAN")
        self.la15=Label(root,textvariable=self.la15_text, width=groesse, bg=farbe, justify=CENTER)
        self.la15.grid(row=15,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.iban = StringVar()
        self.iban.set("")
        self.en15 = Entry(root, width=groesse, textvariable=self.iban)
        ...
        self.la16=Label(root,textvariable=self.la16_text, width=groesse, bg=farbe, justify=CENTER)
        self.la16.grid(row=16,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_1=Button(root,text="Telefon", width=groesse, command=self.aufnahmeTelefon)
        self.bu7_1.grid(row=16,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_2=Button(root,text="Email", width=groesse, command=self.aufnahmeEmail)
        self.bu7_2.grid(row=16,column=2,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_3=Button(root,text="Post", width=groesse, command=self.aufnahmePost)
        self.bu7_3.grid(row=16,column=3,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_4=Button(root,text="Chiffre", width=groesse, command=self.aufnahmeChiffre)
        ...
        self.la17=Label(root,textvariable=self.la17_text, width=groesse, bg=farbe, justify=CENTER)
        self.la17.grid(row=17,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu8_1=Button(root,text="Maennlich", width=groesse, command=self.wunschmann)
        self.bu8_1.grid(row=17,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu9_2=Button(root,text="Weiblich", width=groesse, command=self.wunschfrau)
        ...
        self.la18=Label(root,textvariable=self.la18_text, width=groesse, bg=farbe, justify=CENTER)
        self.la18.grid(row=18,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.walter = StringVar()
        self.walter.set("")
        self.en18 = Entry(root, width=groesse, textvariable=self.walter)
        ...
        self.la19=Label(root,textvariable=self.la19_text, width=groesse, bg=farbe, justify=CENTER)
        self.la19.grid(row=19,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.wgroesse = StringVar()
        self.wgroesse.set("")
        self.en19 = Entry(root, width=groesse, textvariable=self.wgroesse)
        ...
        self.la20=Label(root,textvariable=self.la20_text, width=groesse, bg=farbe, justify=CENTER)
        self.la20.grid(row=20,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_1=Button(root,text="Sportlich", width=groesse, command=self.wunschsportlich)
        self.bu10_1.grid(row=20,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_2=Button(root,text="Schlank", width=groesse, command=self.wunschschlank)
        self.bu10_2.grid(row=20,column=2,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_3=Button(root,text="Vollschlank", width=groesse, command=self.wunschvollschlank)
        self.bu10_3.grid(row=20,column=3,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_4=Button(root,text="Dick", width=groesse, command=self.wunschdick)
        ...
        self.la21=Label(root,textvariable=self.la21_text, width=groesse, bg=farbe, justify=CENTER)
        self.la21.grid(row=21,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu11_1=Button(root,text="Raucher", width=groesse, command=self.wunschraucher)
        self.bu11_1.grid(row=21,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu11_2=Button(root,text="Nichtraucher", width=groesse, command=self.wunschnichtraucher)
        ...
        self.la22=Label(root,textvariable=self.la22_text, width=groesse, bg=farbe, justify=CENTER)
        self.la22.grid(row=22,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.whobby = StringVar()
        self.whobby.set("")
        self.en22 = Entry(root, width=groesse, textvariable=self.whobby)
        self.en22.grid(row=22,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu11_2=Button(root,text="Fertig", width=groesse, command=self.abschicken)
