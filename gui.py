...
class GUI(Tk):
    def __init__(self):
        ...
        self.la1=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        self.la1.grid(row=1,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.name = StringVar()
        self.name.set("")
        self.en1 = Entry(rahmen1, width=8, textvariable=self.name)
        self.en1.grid(row=1,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la2_text=StringVar()
        self.la2_text.set("Vorname")
        self.la2=Label(rahmen1,textvariable=self.la2_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la3=Label(rahmen1,textvariable=self.la3_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la4=Label(rahmen1,textvariable=self.la4_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu1_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu1_2=Button(rahmen1,text="Weiblich", width=20, command=self.frau)
        self.bu1_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la5_text=StringVar()
        self.la5_text.set("Groesse")
        self.la5=Label(rahmen1,textvariable=self.la5_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la6=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        self.la1.grid(row=1,column=0,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu2_1=Button(rahmen1,text="Sportlich", width=20, command=self.sportlich)
        self.bu2_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu2_2=Button(rahmen1,text="Schlank", width=20, command=self.schlank)
        self.bu2_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu2_3=Button(rahmen1,text="Vollschlank", width=20, command=self.vollschlank)
        self.bu2_3.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu2_4=Button(rahmen1,text="Dick", width=20, command=self.dick)
        self.bu2_4.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la7_text=StringVar()
        self.la7_text.set("Rauchverhalten")
        self.la7=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu3_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu3_2=Button(rahmen1,text="Nichtraucher", width=20, command=self.nichtraucher)
        self.bu3_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la8_text=StringVar()
        self.la8_text.set("Sexuelle Orientierung")
        self.la8=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu4_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu4_2=Button(rahmen1,text="Homosexuell", width=20, command=self.homosexuell)
        self.bu4_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu4_3=Button(rahmen1,text="Bisexuell", width=20, command=self.bisexuell)
        self.bu4_3.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la9_text=StringVar()
        self.la9_text.set("Hobbys")
        self.la9=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la10=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la11=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la12=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la13=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu5_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu5_2=Button(rahmen1,text="Email", width=20, command=self.email)
        self.bu5_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu5_3=Button(rahmen1,text="Post", width=20, command=self.post)
        self.bu5_3.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la14_text=StringVar()
        self.la14_text.set("Zahlungsart")
        self.la14=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu6_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu6_2=Button(rahmen1,text="Ueberweisung", width=20, command=self.ueberweisung)
        self.bu6_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)


        self.la15_text=StringVar()
        self.la15_text.set("IBAN")
        self.la15=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la16=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu7_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_2=Button(rahmen1,text="Email", width=20, command=self.aufnahmeEmail)
        self.bu7_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_3=Button(rahmen1,text="Post", width=20, command=self.aufnahmePost)
        self.bu7_3.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu7_4=Button(rahmen1,text="Chiffre", width=20, command=self.aufnahmeChiffre)
        self.bu7_4.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)


        self.la17_text=StringVar()
        self.la17_text.set("Wunsch-Geschlecht")
        self.la17=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu8_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu9_2=Button(rahmen1,text="Weiblich", width=20, command=self.wunschfrau)
        self.bu9_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la18_text=StringVar()
        self.la18_text.set("Wunsch-Alter")
        self.la18=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la19=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.la20=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu10_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_2=Button(rahmen1,text="Schlank", width=20, command=self.wunschschlank)
        self.bu10_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_3=Button(rahmen1,text="Vollschlank", width=20, command=self.wunschvollschlank)
        self.bu10_3.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu10_4=Button(rahmen1,text="Dick", width=20, command=self.wunschdick)
        self.bu10_4.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la21_text=StringVar()
        self.la21_text.set("Wunsch-Rauchverhalten")
        self.la21=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
        ...
        self.bu11_1.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.bu11_2=Button(rahmen1,text="Nichtraucher", width=20, command=self.wunschnichtraucher)
        self.bu11_2.grid(row=1,column=1,sticky=E, padx=abstand_x, pady=abstand_y)

        self.la22_text=StringVar()
        self.la22_text.set("Wunsch-Hobby")
        self.la22=Label(rahmen1,textvariable=self.la1_text, width=20, bg="yellow", justify=CENTER)
